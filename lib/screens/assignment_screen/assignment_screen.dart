...
/// Deklarasi widget "AssignmentScreen" yang merupakan tampilan utama
...
/// Deklarasi State "AssignmentScreen"
...
/// Widget "AssignmentDetailsRow" untuk menampilkan baris detail tugas
...
/// Widget "AssignmentButton" untuk membuat tombol yang terkait dengan tugas
...
/// Widget "LoadingBox" untuk membuat kotak pembacaan loading
...
/// Widget "LoadingAssignment" untuk menampilkan tampilan pembacaan loading ketika data tugas masih dimuat
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(kDefaultPadding),
        color: kOtherColor,
        boxShadow: const [BoxShadow(color: kTextLightColor, blurRadius: 2.0)],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                kHalfSizedBox,
                LoadingBox(height: 60.0, width: double.infinity),
              ],
            ),
          ),
          kHalfSizedBox,
